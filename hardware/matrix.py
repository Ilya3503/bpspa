...
# ==================== НАСТРОЙКИ ====================
MARKER_SIZE = 0.100          # <-- Реальный размер чёрного квадрата маркера в МЕТРАХ (100 мм)
...
marker_corners_3d = {
    0: np.array([
        [0.000, 0.000, 0.000],
        [MARKER_SIZE, 0.000, 0.000],
        [MARKER_SIZE, MARKER_SIZE, 0.000],
        [0.000, MARKER_SIZE, 0.000]
    ], dtype=np.float32),

    1: np.array([
        [0.250, 0.000, 0.000],                    # 25 см правее маркера 0
        [0.250 + MARKER_SIZE, 0.000, 0.000],
        [0.250 + MARKER_SIZE, MARKER_SIZE, 0.000],
        [0.250, MARKER_SIZE, 0.000]
    ], dtype=np.float32),

    2: np.array([
        [0.250, 0.200, 0.000],                    # выше маркера 1
        [0.250 + MARKER_SIZE, 0.200, 0.000],
        [0.250 + MARKER_SIZE, 0.200 + MARKER_SIZE, 0.000],
        [0.250, 0.200 + MARKER_SIZE, 0.000]
    ], dtype=np.float32),

    3: np.array([
        [0.000, 0.200, 0.000],                    # выше маркера 0
        [MARKER_SIZE, 0.200, 0.000],
        [MARKER_SIZE, 0.200 + MARKER_SIZE, 0.000],
        [0.000, 0.200 + MARKER_SIZE, 0.000]
    ], dtype=np.float32),
}
